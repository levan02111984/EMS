...
namespace EMS.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        {
            ViewData["DDLSystemCode"] = new SelectList(_context.SystemCodes, "Id", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Create(SystemCodeDetail systemCodeDetail)
        {
            ...
            ViewData["DDLSystemCode"] = new SelectList(_context.SystemCodes, "Id", "Description", systemCodeDetail.SystemCodeID);
            return View(systemCodeDetail);
        }
